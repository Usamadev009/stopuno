            ...
            <div class="col-6">
                <div class="form-group">
                    <div class="btn btn-default btn-file">
                        ...
                        <input type="file" name="category_banner" id="upload-banner" accept="image/*">
                    </div>
                    <p class="help-block">Max. 5MB</p>
                </div>
            </div>
            <div class="col-6 {{ !empty($category->banner) ? '' : 'd-none' }}" id="banner-display">
                @if (!empty($category->banner))
                    <img class="img-fluid" src="{{ asset($category->banner) }}" alt="img"
                        style="max-height:200px; max-width=" 100px">
                @endif
            </div>
        </div>
